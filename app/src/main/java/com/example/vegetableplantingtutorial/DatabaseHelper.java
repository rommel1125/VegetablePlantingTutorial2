...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO "+TABLE_NAME+" (NAME,DESCRIPTION) VALUES " +
                ...
                "('Mung Beans','Description:\n" +
                "The mung bean (Vigna radiata (L.) R. Wilczek) is a legume cultivated for its edible seeds and sprouts across Asia. There are 3 subgroups of Vigna radiata: one is cultivated (Vigna radiata subsp. radiata), and two are wild (Vigna radiata subsp. sublobata and Vigna radiata subsp. glabra). The mung bean plant is an annual, erect or semi-erect, reaching a height of 0.15-1.25 m (FAO, 2012; Lambrides et al., 2006; Mogotsi, 2006). It is slightly hairy with a well-developed root system. Wild types tend to be prostrate while cultivated types are more erect (Lambrides et al., 2006). The stems are many-branched, sometimes twining at the tips (Mogotsi, 2006). The leaves are alternate, trifoliolate with elliptical to ovate leaflets, 5-18 cm long x 3-15 cm broad. The flowers (4-30) are papillonaceous, pale yellow or greenish in colour. The pods are long, cylindrical, hairy and pending. They contain 7 to 20 small, ellipsoid or cube-shaped seeds. The seeds are variable in colour: they are usually green, but can also be yellow, olive, brown, purplish brown or black, mottled and/or ridged. Seed colours and presence or absence of a rough layer are used to distinguish different types of mung bean (Lambrides et al., 2006; Mogotsi, 2006). Cultivated types are generally green or golden and can be shiny or dull depending on the presence of a texture layer (Lambrides et al., 2006). Golden gram, which has yellow seeds, low seed yield and pods that shatter at maturity, is often grown for forage or green manure. Green gram has bright green seeds, is more prolific and ripens more uniformly, with a lower tendency for pods to shatter. In India, two other types of mung beans exist, one with black seeds and one with brown seeds (Mogotsi, 2006). The mung bean resembles the black gram (Vigna mungo (L.)) with two main differences: the corolla of Vigna mungo is bright yellow while that of Vigna radiata is pale yellow; mung bean pods are pendulous whereas they are erect in black gram. Mung bean is slightly less hairy than black gram. Mung bean is sown on lighter soils than black gram (Göhl, 1982).\n" +
                "\n" +
                "Processes :\n" +
                "Seed harvest\n" +
                "Mung bean crops grown for seeds are generally harvested when pods begin to darken. They are mostly hand-picked at weekly intervals. In newer varieties in which the plants mature uniformly, the whole plants are harvested and sun-dried before being threshed. Once pods have dried, the seeds are removed by beating or trampling (Mogotsi, 2006).\n" +
                "\n" +
                "Forage harvest\n" +
                "The mung bean can be grazed six weeks after planting and two grazings are usually obtained (FAO, 2012). It can be used to make hay, when it should be cut as it begins to flower and then quickly dried for storage. It is possible to make hay without compromising seed harvest.')," +
